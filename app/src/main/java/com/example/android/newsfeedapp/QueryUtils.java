...
/**
 * Helper methods related to requesting and receiving news item data from the Guardian API
...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> newsItemsList = extractFeatureFromJson(jsonResponse);

        // Return the list of {@link News} items
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem retrieving the news items JSON results.", e);
        } finally {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        List<News> newsItemsList = new ArrayList<>();
        ...
        try {
            ...
            // Create a JSONObject from the JSONObject baseJsonResponse
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // key called "fields", which represents a thumbnail image url
                // for that news item.
